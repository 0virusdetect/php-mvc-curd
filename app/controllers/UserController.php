...
$user_id_encoded = $_GET['id'];
list($user_id_encrypted, $iv) = explode('::', base64_decode(urldecode($user_id_encoded)), 2);

// Decrypt the value using the IV
$id = openssl_decrypt($user_id_encrypted, 'aes-256-cbc', 'encryption_key', 0, $iv);
